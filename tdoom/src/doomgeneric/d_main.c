...
#endif
    {
        /* tdoom: the FAT partition mounted by port_system.c. Upstream's
         * auto-detect lands on "." here, which is not a writable location on
         * this device -- config and savegames were silently going nowhere. */
        M_SetConfigDir("/doom/");
    }
