...
void ST_refreshBackground(void)
{
    ...
    if (st_statusbaron)
    {
        /* tdoom: draw straight to the screen, not via st_backing_screen.
         * The backing buffer is copied with V_CopyRect, which does no scaling,
         * so the bar would have stayed 320 wide while the widgets drawn over it
         * were scaled -- misaligned. Drawing it as a normal patch at design-space
         * coordinates lets V_DrawPatch scale both consistently. */
