...
/* tdoom: 20 KB moved to PSRAM. Read/written a handful of times per game tic,
 * so the extra latency is invisible next to a 28ms frame. */
TD_LAZY_ARRAY(ticcmd_set_t, ticdata, BACKUPTICS)
#define ticdata (ticdata_td_get())
